...
- `popup.html/.css/.js` — UI for QR/title selectors, content source choices, layout/DPI config, preview, selection, print launch, import/export
...
- `print.html/.css/.js` — print-friendly layout sized for P-Touch tape widths and honoring layout/DPI options
