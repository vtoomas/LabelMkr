 ...
 *
 * This is a bundled copy to avoid external dependencies inside the extension.
 */
var QRCode;
...
(function () {
  ...
  QRCodeModel.prototype = {
    ...
    createMovieClip: function (_target_mc, _instance_name, _depth) {
  ...
  QRCode = function (el, vOption) {
    ...
    this._htOption = QRCode._getDefault(vOption);
    this._oQRCode = null;
    this._elText = null;
    this._bIsPainted = false;
    this._android = QRCode._getAndroid();
  ...
  QRCode._getDefault = function (htOption) {
    if (!htOption) {
      htOption = {};
    }
    ...
    return {
      width: htOption.width || 128,
      height: htOption.height || 128,
      typeNumber: htOption.typeNumber || 0,
      colorDark: htOption.colorDark || "#000000",
      colorLight: htOption.colorLight || "#ffffff",
      correctLevel: htOption.correctLevel || QRErrorCorrectLevel.H,
      text: htOption.text || "",
    };
  };
